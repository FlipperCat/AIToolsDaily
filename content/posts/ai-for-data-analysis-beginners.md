...
faqs:
  - question: "Can ChatGPT analyze data?"
    answer: "Yes, ChatGPT with Code Interpreter (now called Advanced Data Analysis) can analyze CSV files, create charts, find patterns, and explain insights in plain language."
  - question: "Do I need to know coding to analyze data with AI?"
    answer: "No. Modern AI tools let you upload spreadsheets and ask questions in plain English. The AI handles the technical work."
  - question: "Is AI data analysis accurate?"
    answer: "AI is good at finding patterns and basic statistics. Always verify important findings and understand that AI can misinterpret context or make calculation errors. Trust but verify."
---
...
2. Look for the paperclip icon or "Attach" option
...
Start broad:
"Give me an overview of this data. What does it contain and what are the key insights?"
...
"What if we only look at the last 6 months?"
...
"Show me the data that supports this conclusion"
...
1. Open ChatGPT
2. Upload a CSV you want to understand
3. Ask: "What are the main insights in this data?"
4. Follow up with specific questions

### If You Don't

1. Try Claude.ai (free tier allows some file analysis)
2. Try Julius AI
3. Consider ChatGPT Plus ($20/month) if you'll use it regularly

### Build Skills Over Time

1. Start with simple questions
2. Learn what prompts work best
3. Gradually tackle more complex analysis
4. Combine AI insights with your business knowledge
