...
faqs:
  - question: "What AI tools do project managers use?"
    answer: "Most PMs use AI for meeting notes (Otter.ai, Fireflies), status report drafting (ChatGPT/Claude), and documentation. Few use PM-specific AI tools yet - general AI assistants are more flexible."
  - question: "Can AI replace project managers?"
    answer: "No. AI helps with documentation and communication drafting. It can't manage stakeholders, make judgment calls, or handle the human side of projects. AI saves PMs time on admin tasks."
  - question: "Is Asana AI or Monday AI worth it?"
    answer: "For basic automation and summaries, they're useful. Not worth upgrading plans just for AI. The AI features are nice additions, not game-changers. ChatGPT does most of it for $20/month."
---
...
1. **Meeting documentation** - Transcription and summaries
2. **Communication drafting** - Status updates, stakeholder emails
3. **Documentation** - Process docs, templates, guides
4. **Reporting** - Dashboards, status reports
5. **Research** - Quick answers, best practices
...
**The workflow:**
1. AI joins meeting automatically
2. Full transcription generated
3. PM reviews, extracts action items
4. Action items go into project tool
...
1. **Otter.ai** for meeting transcription (free tier to start)
2. **ChatGPT Plus** for everything else ($20/month)

### Add later if useful:

3. Your PM tool's AI features (if they're included)
4. Notion AI if you document heavily in Notion
