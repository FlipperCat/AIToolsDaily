...
faqs:
  - question: "How many AI tools do I actually need?"
    answer: "Most people need 1-3 AI tools maximum. A general assistant (ChatGPT or Claude), possibly a design tool (Canva), and maybe one specialized tool for your field. If you're paying for more than 3-4 AI subscriptions, you're likely overpaying."
  - question: "Which AI subscriptions are worth keeping?"
    answer: "Keep tools you use weekly that save measurable time. ChatGPT Plus or Claude Pro are worth it for most professionals. Specialized tools are only worth it if they're central to your work. Cancel anything you haven't used in 2 weeks."
  - question: "How do I stop wasting money on AI tools?"
    answer: "Track your actual usage for a month. If you didn't use a tool at least 5 times, cancel it. Start free with new tools and only upgrade when you hit real limitations. Never pay annually upfront for AI tools."
---
...
1. **List every AI subscription you're paying for.** Check your credit card statements.

2. **Track actual usage for 2 weeks.** Don't change behavior, just observe.

3. **Cancel anything you didn't use.** Not "pause" - cancel.

4. **For remaining tools, ask: Could ChatGPT do this?** Often yes.

5. **Never pay annually.** Monthly only. Accept the higher price for flexibility.

6. **One tool per job.** You don't need three writing tools.
