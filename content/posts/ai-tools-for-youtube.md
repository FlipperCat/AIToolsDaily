...
faqs:
  - question: "What AI tools do YouTubers use?"
    answer: "Popular choices include ChatGPT for scripts, Opus Clip for short-form clips, VidIQ or TubeBuddy for SEO, and Canva or Midjourney for thumbnails. Most successful creators use multiple AI tools."
  - question: "Can AI write YouTube scripts?"
    answer: "AI can draft scripts and outlines, but the best content comes from your unique perspective. Use AI for structure and research, then add your personality and expertise."
  - question: "Is it worth paying for YouTube AI tools?"
    answer: "Depends on your channel size and time value. For active creators posting weekly or more, tools like VidIQ Pro or Opus Clip pay for themselves in time saved."
---
...
3. Clean up transcript/video
4. Export to main editor or publish directly
...
Video published → Post to Twitter, LinkedIn, Discord

**Auto-backup:**
Video published → Save to Google Drive

**Analytics summary:**
Weekly → Email summary of performance
...
### Week 1
1. Set up ChatGPT for script outlines
2. Try Canva for your next thumbnail
3. Install VidIQ or TubeBuddy free

### Week 2
4. Use AI for title brainstorming
5. Experiment with auto-captions
6. Try generating descriptions with AI

### Week 3+
7. Add tools based on your specific bottlenecks
8. Build templates and workflows
9. Optimize what's working
