...
faqs:
  - question: "Do AI writing detectors work?"
    answer: "Inconsistently. I tested 8 detectors with the same content - results varied wildly. Human-written content was flagged as AI 30%+ of the time. AI content passed as human 40%+ of the time. They're not reliable enough for high-stakes decisions."
  - question: "Can teachers detect ChatGPT writing?"
    answer: "AI detectors are unreliable enough that using them as proof is problematic. They flag human writing as AI frequently. Better approach: oral follow-ups, in-class writing samples, and assignments that require personal experience."
  - question: "What's the most accurate AI detector?"
    answer: "Originality.ai performed best in my testing but still had significant false positives. No detector achieved reliable accuracy. Results vary by writing style, topic, and length. None should be trusted completely."
---
...
1. **100% Human:** An article I wrote myself in 2022, before ChatGPT existed
2. **100% AI:** Raw ChatGPT output, no editing
3. **AI + Light Edit:** ChatGPT output with minor edits
4. **AI + Heavy Edit:** ChatGPT structure, mostly rewritten
5. **Human + AI Polish:** My writing, edited by Claude for clarity
...
1. AI is trained on human writing
2. Some humans write formally (like AI tends to)
3. Editing AI output makes it less detectable
4. Writing style matters more than generation method
