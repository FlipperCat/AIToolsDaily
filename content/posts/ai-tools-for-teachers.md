...
faqs:
  - question: "Are AI tools appropriate for classroom use?"
    answer: "Yes, when used properly. AI tools can assist with lesson planning, create personalized learning materials, help with grading, and generate practice problems. The key is using AI to enhance teaching, not replace teacher judgment and student interaction."
  - question: "What's the best free AI tool for teachers?"
    answer: "ChatGPT and Claude's free tiers are excellent for lesson planning, creating worksheets, and generating discussion questions. MagicSchool.ai offers education-specific features with a free tier designed for teachers."
  - question: "Can AI help with grading?"
    answer: "AI can assist with rubric-based feedback, check grammar and structure, and provide consistent commentary on common issues. However, final grading decisions and nuanced feedback still benefit from human judgment, especially for subjective assignments."
  - question: "How can teachers use AI ethically?"
    answer: "Use AI as a teaching aid, not a replacement for instruction. Be transparent with students about AI use. Teach AI literacy as part of digital citizenship. Don't use AI to generate content you present as human-written without disclosure."
---
...
**Claude advantage:** Better for long-form content like full unit plans.
**ChatGPT advantage:** Can generate diagrams and visuals.
...
### Elementary Teacher
1. **ChatGPT/Claude** (free) — Lesson planning, activity ideas
2. **Canva Education** (free) — Worksheets, visuals
3. **Diffit** (free) — Differentiated reading
4. **Curipod** (free tier) — Interactive lessons

### Secondary Teacher
1. **Claude** (free) — Long-form planning, essay feedback
2. **MagicSchool.ai** (free tier) — Education-specific tools
3. **Brisk** (free) — Chrome extension for quick tasks
4. **Perplexity** (free) — Research support

### Higher Education
1. **Claude/ChatGPT** — Content creation, research
2. **Gradescope** — Grading efficiency
3. **Canva** — Presentation materials
4. **Perplexity Pro** — Research assistance
