...
faqs:
  - question: "Is Leonardo AI better than Midjourney?"
    answer: "For control and consistency, often yes. Leonardo's model training and ControlNet features give more precise results. For pure artistic quality on first try, Midjourney still wins. Different tools for different needs."
  - question: "Is Leonardo AI free?"
    answer: "Yes, generous free tier with 150 daily tokens. That's about 30-50 images per day. Paid plans start at $10/month for more generations and features."
  - question: "What is Leonardo AI best for?"
    answer: "Game assets, consistent characters, and controlled generations. If you need the same character in multiple images or specific compositions, Leonardo excels. For one-off artistic images, Midjourney is better."
---
...
1. Start with "Leonardo Diffusion XL" model
2. Use "Alchemy" for quality boost
3. Learn negative prompts (what to exclude)
4. Try PhotoReal for realistic images
...
1. Generate base character images
2. Train a custom model (takes a few minutes)
3. Use that model for future generations
