...
faqs:
  - question: "Can lawyers use ChatGPT?"
    answer: "Yes, with caution. ChatGPT is useful for drafting, brainstorming, and understanding concepts. Never cite ChatGPT as a source, always verify case citations (it makes them up), and never input confidential client information into free tools."
  - question: "Is using AI ethical for lawyers?"
    answer: "Yes, if used properly. AI is a tool like legal research databases. The ethical issues are: confidentiality (don't put client data in public AI), competence (verify AI output), and honesty (don't represent AI work as your own research)."
  - question: "What AI tools do law firms use?"
    answer: "Top firms use: legal-specific AI like CoCounsel or Harvey for research, ChatGPT/Claude for drafting with privacy safeguards, contract review AI, and document management AI. Enterprise versions with data protection are standard."
---
...
**What it does:** Legal research with AI
...
**What it does:** Legal AI platform
...
**Template prompt:**
"Draft a response to a client asking about the timeline for their personal injury case. We're in discovery, expecting 3-4 more months before we can evaluate settlement vs. trial. Tone: reassuring but honest. Keep under 150 words."
