...
faqs:
  - question: "Is ChatGPT better than Google?"
    answer: "They're different tools. Google is better for finding specific information, current events, and verified facts. ChatGPT is better for explanations, brainstorming, and working through problems."
  - question: "Can ChatGPT replace Google?"
    answer: "No. ChatGPT has a knowledge cutoff and can't access current information. It also hallucinates sometimes. Use both tools for what they do best."
  - question: "Should I use ChatGPT or Google for research?"
    answer: "Start with ChatGPT to understand concepts and explore ideas. Switch to Google to find sources, verify facts, and get current information. Use both together."
---
...
| Type of Information | Google | ChatGPT |
|---------------------|--------|---------|
...
**Google:** The world's library index
**ChatGPT:** A knowledgeable assistant
