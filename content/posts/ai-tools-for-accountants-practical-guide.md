...
faqs:
  - question: "What AI tools do accountants actually use?"
    answer: "Most accountants use AI for document processing (extracting data from receipts/invoices), client communication drafts, and research. Very few trust AI for actual calculations or tax decisions - they use it for the tedious stuff around the numbers work."
  - question: "Can AI replace accountants?"
    answer: "Not anytime soon. AI handles data entry and document processing well. But judgment calls, complex tax strategy, client relationships, and catching errors require human expertise. AI makes accountants faster, not obsolete."
  - question: "Is AI safe for accounting work?"
    answer: "For research and drafts, yes. For anything client-facing or calculation-based, you must verify. Never trust AI for tax advice or regulatory compliance without checking. Use it to speed up, not replace, your review process."
---
