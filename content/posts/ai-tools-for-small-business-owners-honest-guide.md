...
faqs:
  - question: "What AI tools should small businesses use?"
    answer: "Start with ChatGPT ($20/month) for writing and customer communication, Canva with AI features for design, and an AI-enhanced accounting tool. Add automation (Zapier) only after you have repeatable processes. Total: $50-100/month."
  - question: "Is AI worth it for a one-person business?"
    answer: "Yes, if you focus on the right tools. ChatGPT alone can save 5-10 hours weekly on emails, content creation, and research. The $20/month cost is easily justified. Avoid expensive specialized tools until you've maximized the basics."
  - question: "Which AI tools have the fastest ROI for small businesses?"
    answer: "ChatGPT for customer emails (saves hours weekly), AI accounting like QuickBooks (reduces bookkeeping time 50%), and AI design through Canva (eliminates designer costs for simple projects). These three cover most small business AI needs."
---
...
| Tool | Cost | Value |
|------|------|-------|
| ChatGPT Plus | $20 | Saves 5-10 hours/week |
| Canva Pro | $13 | Eliminates design costs |
| QuickBooks | ~$30 | Cuts bookkeeping time 75% |
| Zapier (Basic) | $20 | Automates 3 key workflows |
| **Total** | **$83** | |
