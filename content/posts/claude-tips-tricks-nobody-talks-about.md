...
faqs:
  - question: "How do I get better results from Claude?"
    answer: "Upload reference documents for style, ask Claude to explain its reasoning before answering, use follow-up conversations instead of new chats, and request specific output formats. Claude excels when you give it context to work with."
  - question: "What is Claude best at?"
    answer: "Claude excels at long-form writing, document analysis, nuanced explanations, following complex multi-step instructions, and maintaining voice consistency. It's less strong than ChatGPT at coding and has no image generation."
  - question: "Is Claude Pro worth $20/month?"
    answer: "Yes if you write content professionally or analyze documents regularly. The quality difference over free tier and over ChatGPT for writing tasks is noticeable. If you mainly need coding help or images, ChatGPT Plus is better value."
---
...
**Example workflow:**
1. Upload 2-3 samples of the voice you want
2. Explain what you're writing
3. Ask Claude to write in that style
...
"Make this 30% more casual."
"Make this 20% more assertive."
