...
faqs:
  - question: "What's the best ChatGPT prompt for writing?"
    answer: "The best prompts include context, audience, tone, and specific requirements. Instead of 'write a blog post,' use 'write a 1,500-word blog post about [topic] for [audience], in a [tone] voice, including [specific elements].'"
  - question: "How do I make ChatGPT write like me?"
    answer: "Provide examples of your writing and ask ChatGPT to match the style. Use prompts like 'Here's a sample of my writing: [paste example]. Write new content in this same voice and style.'"
  - question: "Why does ChatGPT sound generic?"
    answer: "ChatGPT sounds generic when prompts lack specificity. Add details about audience, tone, examples to include, and what makes your content unique. The more specific your prompt, the better the output."
  - question: "Can I use ChatGPT content directly?"
    answer: "You can, but shouldn't without editing. AI content should be a first draft you personalize with your expertise, examples, and voice. Always fact-check, add personal insights, and ensure it sounds like you."
---
...
1. **Context** - Background ChatGPT needs
2. **Specificity** - Exact requirements
...
1. **Iterate** - First output isn't final. Say "make it more [specific]"
2. **Examples** - Show ChatGPT what you want
3. **Constraints** - "Don't do X" is as important as "Do Y"
4. **Length** - Be specific about word counts
5. **Save winners** - Keep prompts that work
