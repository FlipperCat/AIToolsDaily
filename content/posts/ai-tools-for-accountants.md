...
faqs:
  - question: "Will AI replace accountants?"
    answer: "AI handles routine tasks like data entry and categorization. But tax strategy, business advice, and client relationships still need human judgment. AI makes accountants more efficient, not obsolete."
  - question: "What's the best AI tool for accounting?"
    answer: "For automation, Vic.ai and Docyt lead for AP. For general AI assistance, ChatGPT helps with research, communications, and analysis. The right tool depends on your specific bottleneck."
  - question: "Is AI accurate enough for financial work?"
    answer: "Modern AI is highly accurate for routine categorization (95%+). But every financial output should be human-reviewed. AI handles the first pass; you verify and approve."
---
...
### Week 2-4
4. Train AI categorization with corrections
5. Set up client document portal
6. Build email templates

### Month 2+
7. Evaluate firm-specific tools
8. Expand automation
