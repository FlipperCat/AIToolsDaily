...
faqs:
  - question: "Can AI fully automate social media?"
    answer: "AI handles content creation, scheduling, and analytics well. Engagement (responding to comments, DMs) still needs human touch. Expect 70-80% automation, not 100%."
  - question: "What's the best AI tool for social media?"
    answer: "For content creation: ChatGPT/Claude. For scheduling: Buffer or Hootsuite. For images: Canva or Leonardo AI. The best system combines multiple tools."
  - question: "Is automated social media content effective?"
    answer: "Yes, if done well. The key is making AI content sound human, posting consistently, and still engaging manually. Pure automation without personality fails."
---
...
3. Review and select best 20-25 ideas
4. Add to content calendar (I use Notion)
...
1. Open Canva
2. Use "Magic Design" with prompt:
...
3. Adjust and save
4. Export all sizes for different platforms
...
1. Upload all weekly content to Buffer
2. Set optimal posting times (Buffer suggests these)
3. Add images to each post
4. Review queue
5. Schedule
...
**Why manual:**
AI replies feel fake. People notice. Real engagement builds real relationships.
...
**AI prompt style:**
"Write a LinkedIn post about [topic]. Start with a hook that creates curiosity. Use line breaks for readability. End with a question to drive comments."
...
**AI prompt style:**
"Write a Twitter thread (5-7 tweets) about [topic]. First tweet must hook readers in 10 words. Each tweet should stand alone but flow together. End with a call to follow."
...
**AI prompt style:**
"Write caption for Instagram carousel about [topic]. Hook in first line (visible before 'more'). Include 3-5 relevant hashtags at end. Keep under 150 words."
...
1. **Week 1:** Try AI content prompts manually
2. **Week 2:** Set up scheduling tool, start batching
3. **Week 3:** Refine prompts based on what performs
4. **Week 4:** Establish consistent routine
