...
faqs:
  - question: "Is Claude good for writing?"
    answer: "Claude is excellent for writing - many writers consider it the best AI for prose quality. It produces more natural, varied sentences than ChatGPT and follows style instructions well. For writing specifically, Claude is often the better choice."
  - question: "How is Claude different from ChatGPT for writing?"
    answer: "Claude's writing is typically more natural and less formulaic. It varies sentence structure better, uses fewer corporate clichés, and maintains voice consistency better in long pieces. ChatGPT is more versatile overall; Claude excels specifically at writing."
  - question: "Can Claude write long articles?"
    answer: "Yes, Claude handles long-form content extremely well - better than most AI tools. Its large context window means it can maintain coherence across thousands of words. For blog posts, articles, and reports, Claude is ideal."
---
...
"You're a productivity coach writing for tech professionals..."
"You're a finance journalist explaining concepts to beginners..."
...
"Witty and casual"
"Match the attached sample"

### 5. Constraints
"Avoid jargon"
"Don't use these phrases: [list]"
...
**Round 1:** Get the structure and main ideas
**Round 2:** Refine tone and add specifics
**Round 3:** Polish and cut
...
"Write naturally. Use contractions. Vary sentence length. Include personal perspective where appropriate. Avoid corporate jargon and clichés."

## My Actual Workflow

**For a typical blog post:**

1. **Brain dump:** Write rough notes about what I want to cover

2. **Structure prompt:**
"Based on these notes [paste notes], create an outline for a blog post about [topic]. Target length: 1,200 words. Audience: [describe]."

3. **Review outline:** Adjust, add, remove

4. **First draft:**
"Write the full post based on this outline. [Include all constraints]"
...
6. **Human editing:** Add personal stories, specific examples from my experience, check facts, adjust voice
...
1. How specific your prompts are
2. How much you iterate and refine
3. How much you edit and add your own expertise
