...
faqs:
  - question: "What makes a good AI prompt?"
    answer: "Good prompts are specific about the task, include context, specify format and length, and describe the desired tone. Vague prompts get vague results."
  - question: "Do the same prompts work for ChatGPT and Claude?"
    answer: "Mostly yes. Both respond well to clear, specific instructions. Claude sometimes handles nuance better, ChatGPT sometimes follows format better. The templates here work for both."
  - question: "Should I use prompt templates or write custom prompts?"
    answer: "Start with templates, then customize. Templates give you structure that works. Customize the details for your specific needs."
---
