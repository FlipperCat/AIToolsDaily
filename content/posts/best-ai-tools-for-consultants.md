...
faqs:
  - question: "What AI tools do consultants use?"
    answer: "Most consultants use ChatGPT/Claude for research synthesis and proposal drafts, Otter.ai or similar for meeting transcription, and Gamma or Beautiful.ai for presentation creation. These save the most time on daily consulting work."
  - question: "Can AI replace consultants?"
    answer: "No. AI handles research, documentation, and presentation creation faster. But client relationships, strategic judgment, and experience-based advice require humans. AI makes consultants faster, not obsolete."
  - question: "Is Claude or ChatGPT better for consulting work?"
    answer: "Claude is better for longer analysis and strategic documents. ChatGPT is better for quick research and web access. Most consultants I talked to use both for different purposes."
---
...
**For proposals:**
1. Outline key points yourself
2. Ask Claude to draft sections based on your outline
3. Heavy editing - add client-specific examples, adjust tone
...
**For client reports:**
1. Paste raw data and findings
2. Ask for structured analysis
3. Rewrite conclusions based on actual expertise
...
2. Heavily customize design
3. Add proprietary frameworks and data visualization
4. Final polish in PowerPoint or Keynote
